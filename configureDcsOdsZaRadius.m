function cfg = configureDcsOdsZaRadius(cfg, zaRadiusKm)
%configureDcsOdsZaRadius Apply one consistent geographic ZA radius.
%   CFG = configureDcsOdsZaRadius(CFG, ZARADIUSKM) updates every model
...
if zaRadiusKm == 30
    ...
    cfg.meta.baselineId = "DCS-10-SPOT-60-FOR-30DBW-MHZ-ZA" + ...
        upper(zaToken);
    cfg.output.folder = fullfile(fileparts(cfg.output.folder), ...
